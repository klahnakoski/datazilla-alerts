...
CALL python dzAlerts\daemons\alert.py  --settings_file "./talos_alert_settings.json"
CALL python dzAlerts\daemons\email_send.py  --settings_file "./talos_alert_settings.json"

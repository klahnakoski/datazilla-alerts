...
set_default(format_dispatch, {
    ...
    "table": (format_table_from_groupby, format_table_from_groupby, format_table_from_aggop,  "application/json"),
    "list": (format_list_from_groupby, format_list_from_groupby, format_list_from_aggop, "application/json"),
